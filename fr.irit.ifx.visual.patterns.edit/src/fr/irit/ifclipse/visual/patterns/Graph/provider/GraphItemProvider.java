 ...
 * {@link fr.irit.ifclipse.visual.patterns.Graph.Graph} object. <!--
...
public class GraphItemProvider extends NamedElementItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphPackage.Literals.GRAPH__CONTENTS);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				GraphPackage.Literals.GRAPH__CONTENTS,
				GraphFactory.eINSTANCE.createGraphElement()));
		...
		newChildDescriptors.add(createChildParameter(
				GraphPackage.Literals.GRAPH__CONTENTS,
				GraphFactory.eINSTANCE.createDirectedArc()));
	}
