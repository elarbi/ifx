 ...
 * {@link fr.irit.ifclipse.visual.patterns.ComDiag.Message} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MessageItemProvider extends ComDiagElementItemProvider implements
	...
	protected void addOccurencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Message_occurence_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Message_occurence_feature", "_UI_Message_type"),
				ComDiagPackage.Literals.MESSAGE__OCCURENCE, true, false, false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Message_source_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Message_source_feature", "_UI_Message_type"),
				ComDiagPackage.Literals.MESSAGE__SOURCE, true, false, true,
				null, null, null));
	}
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Message_target_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Message_target_feature", "_UI_Message_type"),
				ComDiagPackage.Literals.MESSAGE__TARGET, true, false, true,
				null, null, null));
	}
