 ...
 * {@link fr.irit.ifclipse.visual.patterns.ComDiag.NamedElement} object. <!--
...
public class NamedElementItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ComDiagPackage.Literals.NAMED_ELEMENT__NAME, true, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/NamedElement"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case ComDiagPackage.NAMED_ELEMENT__NAME:
	...
	public ResourceLocator getResourceLocator() {
		return ComDiagEditPlugin.INSTANCE;
	}
