...
public class TransitionItemProvider extends ItemProviderAdapter implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								...
								"_UI_Transition_type"),
						ScenarioParticipantPackage.Literals.TRANSITION__NUMBER,
						true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.TRANSITION__ACTIONS);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.TRANSITION__ACTIONS,
				ScenarioParticipantFactory.eINSTANCE.createAction()));
	}
