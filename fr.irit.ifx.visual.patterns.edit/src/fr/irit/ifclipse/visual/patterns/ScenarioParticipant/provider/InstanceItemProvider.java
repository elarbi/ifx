 ...
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.Instance} object.
...
public class InstanceItemProvider extends ItemProviderAdapter implements
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ScenarioParticipantPackage.Literals.INSTANCE__TYPE, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.INSTANCE__STATE);
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.INSTANCE__PID);
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.INSTANCE__QUEUE);
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.INSTANCE__VARIABLE_SET);
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.INSTANCE__PARAMATER_SET);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.INSTANCE__STATE,
				ScenarioParticipantFactory.eINSTANCE.createState()));

		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.INSTANCE__PID,
				ScenarioParticipantFactory.eINSTANCE.createPid()));

		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.INSTANCE__QUEUE,
				ScenarioParticipantFactory.eINSTANCE.createQueue()));

		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.INSTANCE__VARIABLE_SET,
				ScenarioParticipantFactory.eINSTANCE.createVariableSet()));

		newChildDescriptors.add(createChildParameter(
				ScenarioParticipantPackage.Literals.INSTANCE__PARAMATER_SET,
