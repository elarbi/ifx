...
public class EnabledTransitionsItemProvider extends ItemProviderAdapter
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ScenarioParticipantPackage.Literals.ENABLED_TRANSITIONS__ENABLED_TRANSITIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ScenarioParticipantPackage.ENABLED_TRANSITIONS__ENABLED_TRANSITIONS:
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors
				.add(createChildParameter(
						ScenarioParticipantPackage.Literals.ENABLED_TRANSITIONS__ENABLED_TRANSITIONS,
						ScenarioParticipantFactory.eINSTANCE.createTransition()));
	}
