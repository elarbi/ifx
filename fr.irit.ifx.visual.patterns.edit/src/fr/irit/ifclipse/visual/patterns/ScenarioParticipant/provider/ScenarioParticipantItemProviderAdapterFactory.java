...
import fr.irit.ifclipse.visual.patterns.ScenarioParticipant.util.ScenarioParticipantAdapterFactory;
 ...
 * @generated
 */
public class ScenarioParticipantItemProviderAdapterFactory extends
		ScenarioParticipantAdapterFactory implements ComposeableAdapterFactory,
	 ...
	 * @generated
	 */
	public ScenarioParticipantItemProviderAdapterFactory() {
	 ...
	 * @generated
	 */
	protected ScenarioParticipantItemProvider scenarioParticipantItemProvider;
	...
	public Adapter createScenarioParticipantAdapter() {
		if (scenarioParticipantItemProvider == null) {
			scenarioParticipantItemProvider = new ScenarioParticipantItemProvider(
					this);
		}

		return scenarioParticipantItemProvider;
	}
	...
	public void dispose() {
		if (scenarioParticipantItemProvider != null)
			scenarioParticipantItemProvider.dispose();
		if (instanceItemProvider != null)
