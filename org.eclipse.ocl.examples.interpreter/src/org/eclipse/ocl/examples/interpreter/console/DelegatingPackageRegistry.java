 ...
 * </copyright>
 *
 * $Id: DelegatingPackageRegistry.java,v 1.1 2010/03/11 10:13:26 ewillink Exp $
 */
...
public class DelegatingPackageRegistry extends EPackageRegistryImpl {
	...
	public DelegatingPackageRegistry(EPackage.Registry delegate1,
			EPackage.Registry delegate2) {
	...
	public DelegatingPackageRegistry(List<EPackage.Registry> delegates) {
		this.delegates = new BasicEList.FastCompare<EPackage.Registry>(
				delegates);
	}
	...
	public Collection<Object> values() {
		...
		for (EPackage.Registry next : delegates) {
			// get values from the delegates for the keys that we do not yet
			// have
