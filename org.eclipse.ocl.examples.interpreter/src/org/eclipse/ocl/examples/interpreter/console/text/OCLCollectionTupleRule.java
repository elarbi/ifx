 ...
 * </copyright>
 *
 * $Id: OCLCollectionTupleRule.java,v 1.1 2010/03/11 10:13:27 ewillink Exp $
 */
...
class OCLCollectionTupleRule extends WordRule {
	...
	OCLCollectionTupleRule(ColorManager colorManager, boolean isBraces) {
		...
		IToken token = new Token(new TextAttribute(
				colorManager.getColor(ColorManager.COLLECTION_TUPLE), null,
				SWT.BOLD));
