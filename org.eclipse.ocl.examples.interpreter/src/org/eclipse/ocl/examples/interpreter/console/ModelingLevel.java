 ...
 * </copyright>
 *
 * $Id: ModelingLevel.java,v 1.1 2010/03/11 10:13:27 ewillink Exp $
 */
...
public enum ModelingLevel {
	...
	public <C, O, P> ConstraintKind setContext(OCLHelper<C, O, P, ?> helper,
			EObject element, IOCLFactory<C> factory) throws ParserException {
		switch (this) {
		case M2:
		...
		case M1:
			UMLReflection<?, C, O, P, ?, ?, ?, ?, ?, ?> uml = helper.getOCL()
					.getEnvironment().getUMLReflection();
