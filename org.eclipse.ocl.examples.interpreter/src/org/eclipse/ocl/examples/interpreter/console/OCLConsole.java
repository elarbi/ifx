...
public class OCLConsole extends AbstractConsole {
	 ...
	 */
	private OCLConsole() {
		super(OCLInterpreterMessages.console_title, ImageDescriptor
				.createFromURL(OCLExamplePlugin.getDefault().getBundle()
						.getEntry("/icons/ocl.gif"))); //$NON-NLS-1$
	}
	...
	public static OCLConsole getInstance() {
		if (instance == null) {
			...
			ConsolePlugin.getDefault().getConsoleManager()
					.addConsoles(new IConsole[] { instance });
		}
