...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>IFConfig</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IFConfigExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ifconfig"));
				IFConfig root = IFConfigFactory.eINSTANCE.createIFConfig();
