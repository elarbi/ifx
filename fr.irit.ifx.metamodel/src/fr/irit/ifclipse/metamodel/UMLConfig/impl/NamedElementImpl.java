 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.metamodel.UMLConfig.impl.NamedElementImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class NamedElementImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return UMLConfigPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UMLConfigPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
