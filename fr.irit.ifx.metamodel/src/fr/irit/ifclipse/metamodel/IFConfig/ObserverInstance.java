 ...
 * <ul>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getType <em>
 * Type</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getState <em>
 * State</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getPid <em>
 * Pid</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getQueue <em>
 * Queue</em>}</li>
 * <li>
 ...
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getEventSet
 * <em>Event Set</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getStatus
 * <em>Status</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.ObserverInstance#getCut <em>
 * Cut</em>}</li>
 * </ul>
 * </p>
 * 
 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance()
 * @model
 * @generated
 */
public interface ObserverInstance extends EObject {
	 ...
	 * @see #setType(String)
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_Type()
	 * @model
	 * @generated
	 */
	String getType();
	 ...
	 * @see #setState(State)
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_State()
	 ...
	 * @see #setPid(Pid)
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_Pid()
	 * @model containment="true"
	 * @generated
	 */
	Pid getPid();
	 ...
	 * @see #setQueue(Queue)
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_Queue()
	 * @model containment="true"
	 * @generated
	 */
	Queue getQueue();
	 ...
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_VariableSet()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_ParamaterSet()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_EventSet()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_Status()
	 * @model containment="true"
	 * @generated
	 */
	Status getStatus();
	 ...
	 * @see #setCut(Cut)
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#getObserverInstance_Cut()
	 * @model containment="true"
	 * @generated
	 */
	Cut getCut();
