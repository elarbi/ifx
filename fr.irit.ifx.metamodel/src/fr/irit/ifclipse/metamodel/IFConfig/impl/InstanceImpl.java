 ...
 * <ul>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getType <em>
 * Type</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getState
 * <em>State</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getPid <em>
 * Pid</em>}</li>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getQueue
 * <em>Queue</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getVariableSet
 * <em>Variable Set</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.metamodel.IFConfig.impl.InstanceImpl#getParamaterSet
...
public class InstanceImpl extends EObjectImpl implements Instance {
	...
	protected EClass eStaticClass() {
		return IFConfigPackage.Literals.INSTANCE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__TYPE, oldType, type));
	}
	...
	public NotificationChain basicSetState(State newState,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, IFConfigPackage.INSTANCE__STATE,
					oldState, newState);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setState(State newState) {
		if (newState != state) {
			...
			if (state != null)
				msgs = ((InternalEObject) state).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__STATE, null, msgs);
			if (newState != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__STATE, newState, newState));
	}
	...
	public NotificationChain basicSetPid(Pid newPid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, IFConfigPackage.INSTANCE__PID, oldPid,
					newPid);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPid != pid) {
			...
			if (pid != null)
				msgs = ((InternalEObject) pid).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - IFConfigPackage.INSTANCE__PID,
						null, msgs);
			if (newPid != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__PID, newPid, newPid));
	}
	...
	public NotificationChain basicSetQueue(Queue newQueue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, IFConfigPackage.INSTANCE__QUEUE,
					oldQueue, newQueue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newQueue != queue) {
			...
			if (queue != null)
				msgs = ((InternalEObject) queue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__QUEUE, null, msgs);
			if (newQueue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__QUEUE, newQueue, newQueue));
	}
	...
	public NotificationChain basicSetVariableSet(VariableSet newVariableSet,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, IFConfigPackage.INSTANCE__VARIABLE_SET,
	...
	public void setVariableSet(VariableSet newVariableSet) {
		if (newVariableSet != variableSet) {
			NotificationChain msgs = null;
			if (variableSet != null)
				msgs = ((InternalEObject) variableSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__VARIABLE_SET, null,
						msgs);
			if (newVariableSet != null)
				msgs = ((InternalEObject) newVariableSet).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__VARIABLE_SET, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__VARIABLE_SET, newVariableSet,
					newVariableSet));
	}
	...
	public NotificationChain basicSetParamaterSet(ParameterSet newParamaterSet,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, IFConfigPackage.INSTANCE__PARAMATER_SET,
	...
	public void setParamaterSet(ParameterSet newParamaterSet) {
		if (newParamaterSet != paramaterSet) {
			...
			if (paramaterSet != null)
				msgs = ((InternalEObject) paramaterSet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__PARAMATER_SET,
						null, msgs);
			if (newParamaterSet != null)
				msgs = ((InternalEObject) newParamaterSet).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- IFConfigPackage.INSTANCE__PARAMATER_SET,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.INSTANCE__PARAMATER_SET, newParamaterSet,
					newParamaterSet));
	}
