 ...
 * <ul>
 * <li>{@link fr.irit.ifclipse.metamodel.IFConfig.impl.IFIntegerImpl#getValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class IFIntegerImpl extends VariableValueImpl implements IFInteger {
	...
	protected EClass eStaticClass() {
		return IFConfigPackage.Literals.IF_INTEGER;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.IF_INTEGER__VALUE, oldValue, value));
	}
