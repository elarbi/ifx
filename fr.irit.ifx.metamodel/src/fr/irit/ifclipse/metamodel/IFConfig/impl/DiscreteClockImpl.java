 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.metamodel.IFConfig.impl.DiscreteClockImpl#getValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DiscreteClockImpl extends ClockImpl implements DiscreteClock {
	...
	protected EClass eStaticClass() {
		return IFConfigPackage.Literals.DISCRETE_CLOCK;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IFConfigPackage.DISCRETE_CLOCK__VALUE, oldValue, value));
	}
