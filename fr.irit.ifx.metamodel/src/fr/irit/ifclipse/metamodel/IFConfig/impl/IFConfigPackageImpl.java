 ...
 * @generated
 */
public class IFConfigPackageImpl extends EPackageImpl implements
		IFConfigPackage {
	/**
	 ...
	 * @generated
	 */
	private EClass ifConfigEClass = null;
	 ...
	 * @see fr.irit.ifclipse.metamodel.IFConfig.IFConfigPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IFConfigPackageImpl() {
		super(eNS_URI, IFConfigFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link IFConfigPackage#eINSTANCE} when
	 ...
	 * @generated
	 */
	public static IFConfigPackage init() {
		if (isInited)
			return (IFConfigPackage) EPackage.Registry.INSTANCE
					.getEPackage(IFConfigPackage.eNS_URI);

		// Obtain or create and register package
		IFConfigPackageImpl theIFConfigPackage = (IFConfigPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof IFConfigPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new IFConfigPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theIFConfigPackage.createPackageContents();

		// Initialize created meta-data
		theIFConfigPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theIFConfigPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IFConfigPackage.eNS_URI,
				theIFConfigPackage);
		return theIFConfigPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getIFConfig() {
		return ifConfigEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIFConfig_Instances() {
		return (EReference) ifConfigEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getIFConfig_Observers() {
		return (EReference) ifConfigEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getIFConfig_Clocks() {
		return (EReference) ifConfigEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getIFConfig_TimeConstraint() {
		return (EAttribute) ifConfigEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public IFConfigFactory getIFConfigFactory() {
		return (IFConfigFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		ifConfigEClass = createEClass(IF_CONFIG);
		createEReference(ifConfigEClass, IF_CONFIG__INSTANCES);
		createEReference(ifConfigEClass, IF_CONFIG__OBSERVERS);
		createEReference(ifConfigEClass, IF_CONFIG__CLOCKS);
		createEAttribute(ifConfigEClass, IF_CONFIG__TIME_CONSTRAINT);
	...
	public void initializePackageContents() {
		...
		ifConfigEClass.getESuperTypes().add(this.getNamedElement());
		...
		initEClass(ifConfigEClass, IFConfig.class, "IFConfig", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIFConfig_Instances(), this.getInstance(), null,
				"instances", null, 0, -1, IFConfig.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIFConfig_Observers(), this.getObserverInstance(),
				null, "observers", null, 0, -1, IFConfig.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIFConfig_Clocks(), this.getClock(), null, "clocks",
				null, 0, -1, IFConfig.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIFConfig_TimeConstraint(), ecorePackage.getEString(),
				"timeConstraint", null, 0, 1, IFConfig.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
