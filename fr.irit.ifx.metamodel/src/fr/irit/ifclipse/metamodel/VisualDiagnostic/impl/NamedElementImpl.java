 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.metamodel.VisualDiagnostic.impl.NamedElementImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class NamedElementImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return VisualDiagnosticPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					VisualDiagnosticPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
