 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ComDiag.impl.NamedElementImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public class NamedElementImpl extends EObjectImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return ComDiagPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ComDiagPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
