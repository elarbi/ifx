 ...
 * $Id$
 */
package fr.irit.ifclipse.visual.patterns.ComDiag.util;
 ...
 * @generated
 */
public class ComDiagSwitch<T> {
	/**
	 * The cached model package <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected static ComDiagPackage modelPackage;
	 ...
	 * @generated
	 */
	public ComDiagSwitch() {
		if (modelPackage == null) {
			modelPackage = ComDiagPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComDiagPackage.COM_DIAG: {
			ComDiag comDiag = (ComDiag) theEObject;
			T result = caseComDiag(comDiag);
			if (result == null)
				result = caseNamedElement(comDiag);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ComDiagPackage.COM_DIAG_ELEMENT: {
			ComDiagElement comDiagElement = (ComDiagElement) theEObject;
			T result = caseComDiagElement(comDiagElement);
			if (result == null)
				result = caseNamedElement(comDiagElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ComDiagPackage.LIFELINE: {
			...
			if (result == null)
				result = caseComDiagElement(lifeline);
			if (result == null)
		...
		case ComDiagPackage.MESSAGE: {
			...
			if (result == null)
				result = caseComDiagElement(message);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Com Diag</em>'. <!-- begin-user-doc --> This implementation returns
	 ...
	 * @generated
	 */
	public T caseComDiag(ComDiag object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseComDiagElement(ComDiagElement object) {
		return null;
	}
