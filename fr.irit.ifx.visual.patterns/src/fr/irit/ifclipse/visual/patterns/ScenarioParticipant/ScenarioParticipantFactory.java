 ...
 * @generated
 */
public interface ScenarioParticipantFactory extends EFactory {
	/**
	 ...
	 * @generated
	 */
	ScenarioParticipantFactory eINSTANCE = fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ScenarioParticipantFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Scenario Participant</em>'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Scenario Participant</em>'.
	 * @generated
	 */
	ScenarioParticipant createScenarioParticipant();
	 ...
	 * @generated
	 */
	ScenarioParticipantPackage getScenarioParticipantPackage();
