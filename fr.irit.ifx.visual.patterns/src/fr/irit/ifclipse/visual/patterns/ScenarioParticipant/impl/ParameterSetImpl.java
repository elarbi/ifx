 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ParameterSetImpl#getParamaters
 * <em>Paramaters</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ParameterSetImpl extends EObjectImpl implements ParameterSet {
	...
	protected EClass eStaticClass() {
		return ScenarioParticipantPackage.Literals.PARAMETER_SET;
	}
	...
	public EList<Parameter> getParamaters() {
		if (paramaters == null) {
			paramaters = new EObjectContainmentEList<Parameter>(
					...
					ScenarioParticipantPackage.PARAMETER_SET__PARAMATERS);
		}
		return paramaters;
	}
