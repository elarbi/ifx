 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.EnabledTransitionsImpl#getEnabledTransitions
...
public class EnabledTransitionsImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return ScenarioParticipantPackage.Literals.ENABLED_TRANSITIONS;
	}
	...
	public EList<Transition> getEnabledTransitions() {
		if (enabledTransitions == null) {
			enabledTransitions = new EObjectContainmentEList<Transition>(
					Transition.class,
					this,
					ScenarioParticipantPackage.ENABLED_TRANSITIONS__ENABLED_TRANSITIONS);
		}
