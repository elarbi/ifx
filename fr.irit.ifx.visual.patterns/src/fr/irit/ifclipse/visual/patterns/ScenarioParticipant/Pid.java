 ...
 * </p>
 * 
 * @see fr.irit.ifclipse.visual.patterns.ScenarioParticipant.ScenarioParticipantPackage#getPid()
 * @model
 * @generated
 */
public interface Pid extends VariableValue, NamedElement {
	 ...
	 * @see #setNumber(int)
	 * @see fr.irit.ifclipse.visual.patterns.ScenarioParticipant.ScenarioParticipantPackage#getPid_Number()
	 * @model
	 * @generated
	 */
	int getNumber();
