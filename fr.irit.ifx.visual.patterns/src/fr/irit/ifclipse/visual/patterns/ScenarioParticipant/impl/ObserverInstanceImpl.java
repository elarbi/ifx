 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getType
 * <em>Type</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getState
 * <em>State</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getPid
 * <em>Pid</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getQueue
 * <em>Queue</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getVariableSet
 * <em>Variable Set</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getParamaterSet
 * <em>Paramater Set</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getEventSet
 * <em>Event Set</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getStatus
 * <em>Status</em>}</li>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.ObserverInstanceImpl#getCut
 * <em>Cut</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ObserverInstanceImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return ScenarioParticipantPackage.Literals.OBSERVER_INSTANCE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__TYPE,
					oldType, type));
	}
	...
	public NotificationChain basicSetState(State newState,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__STATE,
					oldState, newState);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetPid(Pid newPid, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__PID, oldPid,
					newPid);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPid(Pid newPid) {
		if (newPid != pid) {
			NotificationChain msgs = null;
			if (pid != null)
				msgs = ((InternalEObject) pid)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- ScenarioParticipantPackage.OBSERVER_INSTANCE__PID,
								null, msgs);
			if (newPid != null)
				msgs = ((InternalEObject) newPid)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- ScenarioParticipantPackage.OBSERVER_INSTANCE__PID,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__PID, newPid,
					newPid));
	}
	...
	public NotificationChain basicSetQueue(Queue newQueue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__QUEUE,
					oldQueue, newQueue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetVariableSet(VariableSet newVariableSet,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__VARIABLE_SET,
	...
	public NotificationChain basicSetParamaterSet(ParameterSet newParamaterSet,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__PARAMATER_SET,
	...
	public NotificationChain basicSetEventSet(EnabledTransitions newEventSet,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__EVENT_SET,
			...
			if (eventSet != null)
				msgs = ((InternalEObject) eventSet)
						.eInverseRemove(
								...
								null, msgs);
			if (newEventSet != null)
				msgs = ((InternalEObject) newEventSet)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- ScenarioParticipantPackage.OBSERVER_INSTANCE__EVENT_SET,
	...
	public NotificationChain basicSetStatus(Status newStatus,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__STATUS,
					oldStatus, newStatus);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetCut(Cut newCut, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__CUT, oldCut,
					newCut);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setCut(Cut newCut) {
		if (newCut != cut) {
			NotificationChain msgs = null;
			if (cut != null)
				msgs = ((InternalEObject) cut)
						.eInverseRemove(
								this,
								EOPPOSITE_FEATURE_BASE
										- ScenarioParticipantPackage.OBSERVER_INSTANCE__CUT,
								null, msgs);
			if (newCut != null)
				msgs = ((InternalEObject) newCut)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- ScenarioParticipantPackage.OBSERVER_INSTANCE__CUT,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ScenarioParticipantPackage.OBSERVER_INSTANCE__CUT, newCut,
					newCut));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__STATE:
			return basicSetState(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__PID:
			return basicSetPid(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__QUEUE:
			return basicSetQueue(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__VARIABLE_SET:
			return basicSetVariableSet(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__PARAMATER_SET:
			return basicSetParamaterSet(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__EVENT_SET:
			return basicSetEventSet(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__STATUS:
			return basicSetStatus(null, msgs);
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__CUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__TYPE:
			return getType();
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__STATE:
			return getState();
		case ScenarioParticipantPackage.OBSERVER_INSTANCE__PID:
