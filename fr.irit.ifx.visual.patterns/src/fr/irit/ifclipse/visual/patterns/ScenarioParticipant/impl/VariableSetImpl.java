 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.VariableSetImpl#getVariables
 * <em>Variables</em>}</li>
 * </ul>
 * </p>
 * 
...
public class VariableSetImpl extends EObjectImpl implements VariableSet {
	...
	protected EClass eStaticClass() {
		return ScenarioParticipantPackage.Literals.VARIABLE_SET;
	}
	...
	public EList<Variable> getVariables() {
		if (variables == null) {
			variables = new EObjectContainmentEList<Variable>(Variable.class,
					this, ScenarioParticipantPackage.VARIABLE_SET__VARIABLES);
		}
		return variables;
	}
