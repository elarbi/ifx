 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.ScenarioParticipant.impl.QueueImpl#getMessages
 * <em>Messages</em>}</li>
 * </ul>
 * </p>
 * 
...
public class QueueImpl extends EObjectImpl implements Queue {
	...
	protected EClass eStaticClass() {
		return ScenarioParticipantPackage.Literals.QUEUE;
	}
	...
	public EList<Message> getMessages() {
		if (messages == null) {
			messages = new EObjectContainmentEList<Message>(Message.class,
					this, ScenarioParticipantPackage.QUEUE__MESSAGES);
		}
		return messages;
	}
