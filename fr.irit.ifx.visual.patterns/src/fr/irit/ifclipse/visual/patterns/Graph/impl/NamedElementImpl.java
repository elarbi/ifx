 ...
 * <ul>
 * <li>
 * {@link fr.irit.ifclipse.visual.patterns.Graph.impl.NamedElementImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public class NamedElementImpl extends EObjectImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return GraphPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GraphPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
