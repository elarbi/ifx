 ...
 * $Id$
 */
package fr.irit.ifclipse.visual.patterns.Graph.util;
...
public class GraphSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GraphPackage.DIRECTED_ARC: {
			...
			if (result == null)
				result = caseGraphElement(directedArc);
			if (result == null)
				result = caseNamedElement(directedArc);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Directed Arc</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
