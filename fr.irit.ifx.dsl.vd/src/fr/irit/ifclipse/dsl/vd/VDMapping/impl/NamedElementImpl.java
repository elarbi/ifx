 ...
 * <ul>
 * <li>{@link fr.irit.ifclipse.dsl.vd.VDMapping.impl.NamedElementImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class NamedElementImpl extends EObjectImpl implements
	...
	protected EClass eStaticClass() {
		return VDMappingPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					VDMappingPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case VDMappingPackage.NAMED_ELEMENT__NAME:
			return getName();
		}
