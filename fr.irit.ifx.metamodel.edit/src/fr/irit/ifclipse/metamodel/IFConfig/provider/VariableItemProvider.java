 ...
 * {@link fr.irit.ifclipse.metamodel.IFConfig.Variable} object. <!--
...
public class VariableItemProvider extends NamedElementItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IFConfigPackage.Literals.VARIABLE__VARIABLE);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.VARIABLE__VARIABLE,
		...
		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.VARIABLE__VARIABLE,
				IFConfigFactory.eINSTANCE.createIFInteger()));

		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.VARIABLE__VARIABLE,
				IFConfigFactory.eINSTANCE.createIFReal()));

		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.VARIABLE__VARIABLE,
				IFConfigFactory.eINSTANCE.createIFBoolean()));
	}
