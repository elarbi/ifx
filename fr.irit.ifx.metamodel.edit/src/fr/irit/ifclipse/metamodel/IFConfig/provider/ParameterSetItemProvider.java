 ...
 * {@link fr.irit.ifclipse.metamodel.IFConfig.ParameterSet} object. <!--
...
public class ParameterSetItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(IFConfigPackage.Literals.PARAMETER_SET__PARAMATERS);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.PARAMETER_SET__PARAMATERS,
