 ...
 * {@link fr.irit.ifclipse.metamodel.IFConfig.Transition} object. <!--
...
public class TransitionItemProvider extends ItemProviderAdapter implements
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Transition_number_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_Transition_number_feature",
								"_UI_Transition_type"),
						IFConfigPackage.Literals.TRANSITION__NUMBER, true,
						false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(IFConfigPackage.Literals.TRANSITION__ACTIONS);
		}
	...
	public String getText(Object object) {
		Integer labelValue = ((Transition) object).getNumber();
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				IFConfigPackage.Literals.TRANSITION__ACTIONS,
				IFConfigFactory.eINSTANCE.createAction()));
	}
