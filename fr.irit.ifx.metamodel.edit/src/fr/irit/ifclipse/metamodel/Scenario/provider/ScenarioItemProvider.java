 ...
 * $Id$
 */
package fr.irit.ifclipse.metamodel.Scenario.provider;
...
import fr.irit.ifclipse.metamodel.IFConfig.provider.NamedElementItemProvider;
import fr.irit.ifclipse.metamodel.Scenario.Scenario;
import fr.irit.ifclipse.metamodel.Scenario.ScenarioPackage;

/**
 * This is the item provider adapter for a
 * {@link fr.irit.ifclipse.metamodel.Scenario.Scenario} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ScenarioItemProvider extends NamedElementItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.SCENARIO__PIDS);
			childrenFeatures
					.add(ScenarioPackage.Literals.SCENARIO__FIRED_TRANSITIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Scenario"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ScenarioPackage.Literals.SCENARIO__PIDS,
				IFConfigFactory.eINSTANCE.createPid()));

		newChildDescriptors.add(createChildParameter(
				ScenarioPackage.Literals.SCENARIO__FIRED_TRANSITIONS,
				IFConfigFactory.eINSTANCE.createTransition()));
	}
