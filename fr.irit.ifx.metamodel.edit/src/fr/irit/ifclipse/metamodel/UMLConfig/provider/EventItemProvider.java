 ...
 * {@link fr.irit.ifclipse.metamodel.UMLConfig.Event} object. <!--
...
public class EventItemProvider extends ItemProviderAdapter implements
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Event_number_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Event_number_feature", "_UI_Event_type"),
				UMLConfigPackage.Literals.EVENT__NUMBER, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UMLConfigPackage.Literals.EVENT__ACTIONS);
		}
	...
	public String getText(Object object) {
		Integer labelValue = ((Event) object).getNumber();
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				UMLConfigPackage.Literals.EVENT__ACTIONS,
				UMLConfigFactory.eINSTANCE.createAction()));
	}
