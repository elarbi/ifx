 ...
 * {@link fr.irit.ifclipse.metamodel.UMLConfig.Message} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class MessageItemProvider extends ItemProviderAdapter implements
	...
	protected void addSignalTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				UMLConfigPackage.Literals.MESSAGE__SIGNAL_TYPE, true, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(UMLConfigPackage.Literals.MESSAGE__DESTINATION_PID);
		}
	...
	public String getText(Object object) {
		String label = ((Message) object).getSignalType();
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				UMLConfigPackage.Literals.MESSAGE__DESTINATION_PID,
